...
elevenlabs) or auto-detects it (openai).
"""
...
LANGUAGE_MAP: dict[str, dict[str, str]] = {
    ...
    "nl": {"google": "nl-NL", "elevenlabs": "nl", "cartesia": "nl", "azure": "nl-NL"},
    "en": {"google": "en-US", "elevenlabs": "en", "cartesia": "en", "azure": "en-US"},
    "et": {"google": "et-EE", "elevenlabs": "et", "azure": "et-EE"},
    "fi": {"google": "fi-FI", "elevenlabs": "fi", "cartesia": "fi", "azure": "fi-FI"},
    "fr": {"google": "fr-FR", "elevenlabs": "fr", "cartesia": "fr", "azure": "fr-FR"},
    "gl": {"google": "gl-ES", "elevenlabs": "gl", "azure": "gl-ES"},
    "de": {"google": "de-DE", "elevenlabs": "de", "cartesia": "de", "azure": "de-DE"},
    ...
    "hi": {"google": "hi-IN", "elevenlabs": "hi", "cartesia": "hi", "azure": "hi-IN"},
    "hu": {"google": "hu-HU", "elevenlabs": "hu", "cartesia": "hu", "azure": "hu-HU"},
    "id": {"google": "id-ID", "elevenlabs": "id", "cartesia": "id", "azure": "id-ID"},
    "it": {"google": "it-IT", "elevenlabs": "it", "cartesia": "it", "azure": "it-IT"},
    ...
    "pl": {"google": "pl-PL", "elevenlabs": "pl", "cartesia": "pl", "azure": "pl-PL"},
    "pt": {"google": "pt-BR", "elevenlabs": "pt", "cartesia": "pt", "azure": "pt-BR"},
    "pa": {"google": "pa-IN", "elevenlabs": "pa", "cartesia": "pa", "azure": "pa-IN"},
    "ro": {"google": "ro-RO", "elevenlabs": "ro", "cartesia": "ro", "azure": "ro-RO"},
    "ru": {"google": "ru-RU", "elevenlabs": "ru", "cartesia": "ru", "azure": "ru-RU"},
    ...
    "es": {"google": "es-ES", "elevenlabs": "es", "cartesia": "es", "azure": "es-ES"},
    "sw": {"google": "sw-KE", "elevenlabs": "sw", "azure": "sw-KE"},
    "sv": {"google": "sv-SE", "elevenlabs": "sv", "cartesia": "sv", "azure": "sv-SE"},
...
def is_language_supported(language: str, provider: str) -> bool:
    ...
    if provider == "soniox":
        return True
    # Cartesia, Azure, and ElevenLabs only support languages with an explicit
    # mapping; Google and OpenAI handle unmapped languages gracefully.
    if provider in ("cartesia", "azure", "elevenlabs"):
