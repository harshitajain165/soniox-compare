...
Most providers accept the raw 16 kHz PCM stream because they let us declare the
input sample rate. A few (e.g. OpenAI's GA Realtime "audio/pcm" format, which is
pinned to 24 kHz) require a fixed rate instead, so they can opt into this
streaming resampler.
"""
