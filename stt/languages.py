...
LANGUAGE_MAP: dict[str, dict[str, str]] = {
    ...
    "bn": {"azure": "bn-IN", "deepgram": "bn", "elevenlabs": "bn", "google": "bn-IN", "meta": "Bengali", "speechmatics": "bn"},
    ...
    "de": {"assembly": "de", "azure": "de-DE", "deepgram": "de", "elevenlabs": "de", "google": "de-DE", "meta": "German", "openai": "de", "speechmatics": "de"},
    "el": {"azure": "el-GR", "deepgram": "el", "elevenlabs": "el", "google": "el-GR", "openai": "el", "speechmatics": "el"},
    "en": {"assembly": "en", "azure": "en-US", "cartesia": "en", "deepgram": "en", "elevenlabs": "en", "google": "en-US", "meta": "English", "openai": "en", "speechmatics": "en"},
    "es": {"assembly": "es", "azure": "es-ES", "deepgram": "es", "elevenlabs": "es", "google": "es-419", "meta": "Spanish", "openai": "es", "speechmatics": "es"},
    ...
    "fr": {"assembly": "fr", "azure": "fr-FR", "deepgram": "fr", "elevenlabs": "fr", "google": "fr-FR", "meta": "French", "openai": "fr", "speechmatics": "fr"},
    "gl": {"azure": "gl-ES", "elevenlabs": "gl", "google": "gl-ES", "openai": "gl", "speechmatics": "gl"},
    "gu": {"azure": "gu-IN", "deepgram": "gu", "elevenlabs": "gu", "google": "gu-IN"},
    "he": {"assembly": "he", "azure": "he-IL", "deepgram": "he", "elevenlabs": "he", "google": "he-IL", "meta": "Hebrew", "openai": "he", "speechmatics": "he"},
    "hi": {"assembly": "hi", "azure": "hi-IN", "deepgram": "hi", "elevenlabs": "hi", "google": "hi-IN", "meta": "Hindi", "openai": "hi", "speechmatics": "hi"},
    ...
    "it": {"assembly": "it", "azure": "it-IT", "deepgram": "it", "elevenlabs": "it", "google": "it-IT", "meta": "Italian", "openai": "it", "speechmatics": "it"},
    "ja": {"assembly": "ja", "azure": "ja-JP", "deepgram": "ja", "elevenlabs": "ja", "google": "ja-JP", "meta": "Japanese", "openai": "ja", "speechmatics": "ja"},
    "kk": {"azure": "kk-KZ", "elevenlabs": "kk", "google": "kk-KZ", "openai": "kk"},
    "kn": {"azure": "kn-IN", "deepgram": "kn", "elevenlabs": "kn", "google": "kn-IN", "meta": "Kannada", "openai": "kn"},
    "ko": {"azure": "ko-KR", "deepgram": "ko", "elevenlabs": "ko", "google": "ko-KR", "meta": "Korean", "openai": "ko", "speechmatics": "ko"},
    ...
    "ml": {"azure": "ml-IN", "elevenlabs": "ml", "google": "ml-IN"},
    "mr": {"azure": "mr-IN", "deepgram": "mr", "elevenlabs": "mr", "google": "mr-IN", "meta": "Marathi", "openai": "mr", "speechmatics": "mr"},
    "ms": {"azure": "ms-MY", "deepgram": "ms", "elevenlabs": "ms", "google": "ms-MY", "meta": "Malay", "openai": "ms", "speechmatics": "ms"},
    "nl": {"assembly": "nl", "azure": "nl-NL", "deepgram": "nl", "elevenlabs": "nl", "google": "nl-NL", "meta": "Dutch", "openai": "nl", "speechmatics": "nl"},
    ...
    "pt": {"assembly": "pt", "azure": "pt-PT", "deepgram": "pt", "elevenlabs": "pt", "google": "pt-BR", "meta": "Portuguese", "openai": "pt", "speechmatics": "pt"},
    "ro": {"azure": "ro-RO", "deepgram": "ro", "elevenlabs": "ro", "google": "ro-RO", "openai": "ro", "speechmatics": "ro"},
    "ru": {"azure": "ru-RU", "deepgram": "ru", "elevenlabs": "ru", "google": "ru-RU", "openai": "ru", "speechmatics": "ru"},
    ...
    "ta": {"azure": "ta-IN", "deepgram": "ta", "elevenlabs": "ta", "meta": "Tamil", "openai": "ta", "speechmatics": "ta"},
    "te": {"azure": "te-IN", "deepgram": "te", "elevenlabs": "te", "google": "te-IN", "meta": "Telugu"},
    ...
    "zh": {"assembly": "zh", "azure": "zh-CN", "deepgram": "zh", "elevenlabs": "zh", "google": "cmn-Hans-CN", "meta": "Mandarin Chinese", "openai": "zh", "speechmatics": "cmn"},
}
