...
LANGUAGE_MAP: dict[str, dict[str, str]] = {
    ...
    "ar": {"assembly": "ar", "azure": "ar-AE", "deepgram": "ar", "elevenlabs": "ar", "google": "ar-EG", "openai": "ar", "speechmatics": "ar"},
    ...
    "bn": {"azure": "bn-IN", "deepgram": "bn", "elevenlabs": "bn", "google": "bn-IN", "speechmatics": "bn"},
    ...
    "es": {"assembly": "es", "azure": "es-ES", "deepgram": "es", "elevenlabs": "es", "google": "es-419", "openai": "es", "speechmatics": "es"},
    ...
    "he": {"assembly": "he", "azure": "he-IL", "deepgram": "he", "elevenlabs": "he", "google": "he-IL", "openai": "he", "speechmatics": "he"},
    "hi": {"assembly": "hi", "azure": "hi-IN", "deepgram": "hi", "elevenlabs": "hi", "google": "hi-IN", "openai": "hi", "speechmatics": "hi"},
    ...
    "id": {"azure": "id-ID", "deepgram": "id", "elevenlabs": "id", "google": "id-ID", "openai": "id", "speechmatics": "id"},
    ...
    "kn": {"azure": "kn-IN", "deepgram": "kn", "elevenlabs": "kn", "google": "kn-IN", "openai": "kn"},
    ...
    "mr": {"azure": "mr-IN", "deepgram": "mr", "elevenlabs": "mr", "google": "mr-IN", "openai": "mr", "speechmatics": "mr"},
    "ms": {"azure": "ms-MY", "deepgram": "ms", "elevenlabs": "ms", "google": "ms-MY", "openai": "ms", "speechmatics": "ms"},
    "nl": {"assembly": "nl", "azure": "nl-NL", "deepgram": "nl", "elevenlabs": "nl", "google": "nl-NL", "openai": "nl", "speechmatics": "nl"},
    ...
    "pl": {"azure": "pl-PL", "deepgram": "pl", "elevenlabs": "pl", "google": "pl-PL", "openai": "pl", "speechmatics": "pl"},
    ...
    "te": {"azure": "te-IN", "deepgram": "te", "elevenlabs": "te", "google": "te-IN"},
    "th": {"azure": "th-TH", "deepgram": "th", "elevenlabs": "th", "google": "th-TH", "openai": "th", "speechmatics": "th"},
    "tl": {"azure": "fil-PH", "deepgram": "tl", "elevenlabs": "tl", "google": "fil-PH", "openai": "tl"},
    "tr": {"assembly": "tr", "azure": "tr-TR", "deepgram": "tr", "elevenlabs": "tr", "google": "tr-TR", "openai": "tr", "speechmatics": "tr"},
    ...
    "vi": {"assembly": "vi", "azure": "vi-VN", "deepgram": "vi", "elevenlabs": "vi", "google": "vi-VN", "openai": "vi", "speechmatics": "vi"},
