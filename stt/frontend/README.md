...
This frontend application provides a user interface for real-time comparison of Speech-to-Text (STT) providers, displaying live transcripts from Soniox and other selected providers side by side.
...
*   **Provider Outputs**: Stores transcript data (final and non-final parts), errors, and status messages for each selected provider.
