...
// `targetLanguage` overrides the dropdown when the sample is picked — pick a
// language that makes sense given the audio's source.
const PREDEFINED_AUDIO_FILES: {
  ...
  {
    id: "german_call_short.mp3",
    name: "German speech with address",
    languages: "German",
    url: "https://soniox.com/media/examples/german_call_short.mp3",
    defaults: {
      languageHints: ["de"],
      targetLanguage: "en",
    },
  ...
  {
    id: "spanish_call_short.mp3",
    name: "Spanish phone call",
    languages: "Spanish",
    url: "https://soniox.com/media/examples/spanish_call_short.mp3",
    defaults: {
      languageHints: ["es"],
      targetLanguage: "en",
    },
  ...
  {
    id: "spanish_weather_report.mp3",
    name: "Weather report",
    languages: "Spanish",
    url: "https://soniox.com/media/examples/spanish_weather_report.mp3",
    defaults: {
      languageHints: ["es"],
      targetLanguage: "en",
    },
  ...
  {
    id: "stt_it_en.mp3",
    name: "Italian and English conversation",
